...
public class FragmentListEvent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Initialize views
        recyclerView = fragmentView.findViewById(R.id.eventRecycler);

        layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);


//        SharedPreferences sharedPreferences = getActivity().getApplicationContext().getSharedPreferences(KeyStore.EVENT_FILE_NAME, MODE_PRIVATE);
